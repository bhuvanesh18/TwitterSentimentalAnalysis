...
def main(request):
    ...
    return render(request,'TweetAnalysisApp/hashtagresult.html',context={'positive_tweets': ptweets,'negative_tweets':ntweets,'pp':positive_percentage,'np':negative_percentage,'ntp':neutral_percentage})